...
if __name__ == '__main__':
    ...
    promot_txt = ','.join(['mouse', 'cat', 'dog', 'person who is smoking', 'person who is shirtless','person without clothing'])
    classes = [3, 4, 5, 1, 2, 2]
    ...
    for i in tqdm(os.listdir(picture_dir)):
        ...
        # if i != 'ele_e88767c0692f4f03a2b5260038671e0d.jpg':
        #     continue
        ...
        if length == 0:
            ...
            res_class = 0
            category_set = set([classes[k['category_id']] for k in res])
